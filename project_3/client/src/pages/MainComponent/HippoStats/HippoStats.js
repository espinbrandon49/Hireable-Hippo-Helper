    ...
    <div>
      ...
      <div class="control is-justify-content-center" style={styles.border}>
        <label class="radio" for="appliedData" style={styles.font}>
          <input type="radio" name="appliedData" id="appliedData" style={styles.width}/>
          Applied
        </label>
        ...
        <label class="radio" for="technicalInterviewData" style={styles.font}>
          <input type="radio" name="rsvp" style={styles.width}/>
          Technical Interview
        </label>
        <label class="radio" for="inPersonInterviewData" style={styles.font}>
          <input type="radio" name="rsvp" style={styles.width} />
          In-person Interview
        </label>
